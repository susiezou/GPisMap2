...
#define GPISMAP3_TREE_CLUSTER_HALF_LENGTH   (0.05)//(0.025)
#define GPISMAP3_TREE_MIN_HALF_LENGTH       (0.0125)//(0.0125/2.0)
#define GPISMAP3_TREE_MAX_HALF_LENGTH       (409.8)//(1.6)
#define GPISMAP3_TREE_INIT_ROOT_HALF_LENGTH (204.8)//(0.4)
...
/* GPisMap3 */
#define GPISMAP3_MAX_RANGE   10e1 //7e1
